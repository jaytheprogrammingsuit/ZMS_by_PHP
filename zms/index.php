				...
				<div class="container">
					...
					<div class="banner-grids">
						<div class="col-md-6 banner-grid">
							<h4>dfgd rtrr dg</h4>
							<p>dfgdg rdrg dgjf dui velit, hendrerit id pharetra nec, posuere porta nisl. Donec magna nulla, commodo in ultrices faucibus lacus aliquet.</p>
						</div>
						<div class="col-md-6 banner-grid">
						<h4>fxf fsdf Earum Rerum</h4>
							<p>fdfgdg dg hendrerit id pharetra nec, posuere porta nisl. Donec magna nulla, commodo in ultrices faucibus lacus aliquet.</p>
						</div>
